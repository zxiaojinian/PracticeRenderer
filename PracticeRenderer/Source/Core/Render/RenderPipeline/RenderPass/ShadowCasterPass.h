...
//Shadow Acne
//	1.light direction depth bias + normal direction bias（bias需要根据阴影纹理纹素覆盖范围来缩放）
//	2.缩小阴影投射视锥体近裁剪面和远裁剪面距离，提升阴影纹理精度
...
//PCF--存在2个问题
	...
	//2，PCF样本范围过大，会加剧Shadow Acne，因为和阴影纹理样本比较不是其对应几何物体的光空间深度。这时需要更大的bias

//级联间的混合，一种性能较好的方式，抖动（https://catlikecoding.com/unity/tutorials/custom-srp/directional-shadows/#4.8）

//级联间有重合区域，是不是可以把重合区域物体从较大级联区域渲染中剔除来提升性能？
namespace PR
{
